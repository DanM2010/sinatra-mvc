...
describe 'Our Numerology App' do
  ...
  it "has a layout" do
    get '/07041774'
    expect(last_response.body).to include("<title>Dan's Numerology App for Skillcrush 204</title>")
  end

  it "has message in a paragraph" do
    get '/01012000'
    expect(last_response.body).to include("<p>\nYour birth path number is:")
  end    
  ...
  it "displays an error message if the input is too short" do
    ...
    expect(last_response).to match(/#{'Please enter your date of birth in the format DDMMYYYY'}/)
  end
